...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Modern primary colors inspired by the screenshots
        primary: {
          50: '#fff7ed',
          100: '#ffedd5',
          200: '#fed7aa',
        ...
        secondary: {
          ...
          300: '#f0abfc',
          400: '#e879f9',
          500: '#d946ef', // Vibrant pink/magenta
          600: '#c026d3',
          700: '#a21caf',
          800: '#86198f',
          900: '#701a75',
      ...
      // Modern gradients inspired by the screenshots
      backgroundImage: {
        ...
        'gradient-sunset': 'linear-gradient(135deg, #f97316 0%, #f59e0b 50%, #d946ef 100%)',
      },
